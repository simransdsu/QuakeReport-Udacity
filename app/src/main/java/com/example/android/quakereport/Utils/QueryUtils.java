...
public final class QueryUtils {
     ...
     */
    public static ArrayList<EarthquakeInfo> extractEarthquakes(String earthquakeJSONResponse) {
        ...
        try {
            ...
            JSONObject earthQuakeAPIResponse = new JSONObject(earthquakeJSONResponse);
